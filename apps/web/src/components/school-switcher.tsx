        ...
        <div className="relative">
            ...
            >
                ...
                <div className="text-left">
                    ...
                    <div className="text-xs text-muted-foreground">{currentSchool.code}</div>
                </div>
                ...
                <>
                    ...
                    <div className="absolute top-full left-0 mt-2 w-72 bg-white border rounded-lg shadow-lg z-50">
                        ...
                        <div className="max-h-64 overflow-y-auto">
                            {schools.length === 0 ? (
                                <div className="p-4 text-center text-muted-foreground text-sm">No other schools available</div>
                            ) : (
                                schools.map(school => (
                                    <button
                                        key={school.id}
                                        onClick={() => { onSchoolChange(school); setIsOpen(false); }}
                                        className={`w-full flex items-center gap-3 p-3 hover:bg-muted transition-colors ${school.id === currentSchool.id ? 'bg-blue-50' : ''}`}
                                    >
                                        ...
                                        <div className="flex-1 text-left">
                                            ...
                                            <div className="text-xs text-muted-foreground">{school.code} • {school.studentCount} students</div>
                                        </div>
