...
// Use standard environment variable for database connection
let connectionString = process.env.DATABASE_URL || 'postgresql://school_admin:school_sis_dev_2026@localhost:5432/school_sis';
