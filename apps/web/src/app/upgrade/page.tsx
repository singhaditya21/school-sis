...
function UpgradeContent() {
    ...
    return (
        <div className="min-h-screen bg-muted flex flex-col items-center justify-center p-4">
            <div className="bg-white p-10 rounded-3xl shadow-xl max-w-2xl w-full text-center border border-border">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10 text-left">
                    <div className="p-6 bg-muted rounded-2xl border border-border">
                        <h3 className="font-semibold text-foreground mb-2">AI Pro Tier</h3>
                        <p className="text-sm text-muted-foreground mb-4">$18 / student / year</p>
                ...
                <div className="flex justify-center gap-4">
                    ...
                    <button onClick={() => window.history.back()} className="px-8 py-4 bg-white text-foreground rounded-xl font-medium hover:bg-muted transition-colors border border-border">
                        Go Back
                    </button>
                </div>
            </div>
...
export default function UpgradePaywall() {
    return (
        <Suspense fallback={<div className="min-h-screen bg-muted flex items-center justify-center"><p className="text-muted-foreground">Loading...</p></div>}>
            <UpgradeContent />
        </Suspense>
    );
}
