...
export default async function UniversityDashboard() {
    ...
    return (
        <div className="max-w-7xl mx-auto p-8 space-y-8">
            <div>
                <h1 className="text-3xl font-black text-foreground mb-2">Higher Education Administration</h1>
                <p className="text-muted-foreground">Manage degree programs, credit distributions, and faculty research.</p>
            </div>
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-sm text-left">
                            ...
                            <tbody className="divide-y divide-gray-100">
                                ...
                                {programs.map((prog) => (
                                    <tr key={prog.id} className="hover:bg-muted transition-colors group">
                                        <td className="px-6 py-4 font-bold text-foreground">{prog.name}</td>
                                        ...
                                        <td className="px-6 py-4 text-muted-foreground font-medium">{new Date(prog.createdAt).getFullYear()}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
