      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-2 text-base">
            Manage degree-specific courses, CBCS credits, and faculty syllabi.
          </p>
        </div>
        <Button asChild variant="outline" className="bg-card">
          <Link href="/university">Manage catalog</Link>
        </Button>
      </div>
      ...
      <Card className="border-0 shadow-lg bg-card overflow-hidden mt-8">
        <CardHeader className="bg-muted border-b border-border px-6 py-5 flex flex-row items-center justify-between">
          <div>
            ...
            <CardDescription>
              Courses mapped across all university programs.
            </CardDescription>
          </div>
        </CardHeader>
              ...
              <tbody className="divide-y divide-gray-100">
                {courses.length === 0 && (
                  <tr>
                    ...
                    >
                      No courses found. Add a course to start assigning faculty
                      workloads.
                    </td>
                  </tr>
                )}
