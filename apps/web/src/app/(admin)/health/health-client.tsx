                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <Card className="shadow-sm border-blue-100 bg-blue-50/40">
                            <CardContent className="pt-6">
                                ...
                                <div className="text-3xl font-bold text-gray-900">{stats.studentsWithRecords.toLocaleString()}</div>
                            </CardContent>
                        </Card>
                        <Card className="shadow-sm border-orange-100 bg-orange-50/40">
                            <CardContent className="pt-6">
                                ...
                                <div className="text-3xl font-bold text-gray-900">{stats.totalIncidents.toLocaleString()}</div>
                            </CardContent>
                        </Card>
                        <Card className="shadow-sm border-red-200 bg-red-50/40 relative overflow-hidden">
                            ...
                            <CardContent className="pt-6 relative z-10">
                                ...
                                <div className="text-3xl font-bold text-red-700">{stats.todayIncidents}</div>
                            </CardContent>
                        </Card>
                        <Card className="shadow-sm border-green-100 bg-green-50/40">
                            <CardContent className="pt-6">
                                ...
                                <div className="text-3xl font-bold text-gray-900">{stats.totalImmunizations.toLocaleString()}</div>
                            </CardContent>
                        </Card>
                    </div>
