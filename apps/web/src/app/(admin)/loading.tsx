        ...
        <div className="space-y-6 animate-pulse">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <div className="h-4 w-64 bg-muted dark:bg-gray-900 rounded mt-2" />
                </div>
            ...
            <div className="bg-card rounded-xl border border-border dark:border-gray-800 overflow-hidden">
                ...
                {[1, 2, 3, 4, 5].map(i => (
                    <div key={i} className="flex items-center gap-4 px-4 py-4 border-t border-border dark:border-gray-900">
                        <div className="h-4 w-32 bg-muted dark:bg-gray-900 rounded" />
                        <div className="h-4 w-24 bg-muted dark:bg-gray-900 rounded" />
                        <div className="h-4 w-16 bg-muted dark:bg-gray-900 rounded ml-auto" />
                    </div>
                ))}
            </div>
        </div>
