    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-wrap items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold text-foreground">Exams &amp; Gradebook</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-white rounded-xl shadow-sm border p-4">
                    ...
                    <p className="text-2xl font-bold text-foreground">
                        {totalEntered}
                        <span className="text-base font-medium text-muted-foreground"> / {totalExpected}</span>
                    </p>
                </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border">
                ...
                {exams.length === 0 ? (
                    <div className="p-8 text-center">
                        <p className="font-medium text-foreground">No exams created yet</p>
                        ...
                        {exams.map((exam) => {
                            ...
                            return (
                                <Link
                                    key={exam.id}
                                    href={`/exams/${exam.id}`}
                                    className="flex flex-wrap items-center justify-between gap-4 p-4 hover:bg-muted transition-colors"
                                >
