    ...
    return (
        <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-8 bg-muted/20 min-h-screen">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h1 className="text-3xl font-black tracking-tight text-foreground">Coaching Institute Intelligence</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <Card className="border-none shadow-md overflow-hidden bg-card group hover:shadow-lg transition-all">
                    ...
                    <CardContent className="p-6">
                        ...
                        <h3 className="text-xl font-bold text-foreground mb-2">Live Batches</h3>
                        <p className="text-muted-foreground text-sm leading-relaxed">View all intensive academic cohorts currently operational.</p>
                ...
                <Card className="border-none shadow-md overflow-hidden bg-card group hover:shadow-lg transition-all">
                    ...
                    <CardContent className="p-6">
                        ...
                        <h3 className="text-xl font-bold text-foreground mb-2">Test Series</h3>
                        <p className="text-muted-foreground text-sm leading-relaxed">AI-tracked mock exams and continuous assessment algorithms.</p>
                ...
                <Card className="border-none shadow-md overflow-hidden bg-card group hover:shadow-lg transition-all">
                    ...
                    <CardContent className="p-6">
                        ...
                        <h3 className="text-xl font-bold text-foreground mb-2">Doubt Hub</h3>
                        <p className="text-muted-foreground text-sm leading-relaxed">Queue of student queries waiting for SME resolution in Physics.</p>
                ...
                <Card className="border-none shadow-md overflow-hidden bg-card group hover:shadow-lg transition-all">
                    ...
                    <CardContent className="p-6">
                        ...
                        <h3 className="text-xl font-bold text-foreground mb-2">AI Rank Predictor</h3>
                        <p className="text-muted-foreground text-sm leading-relaxed">Model updated 2 hours ago using latest AITS performance data vectors.</p>
                            ...
                            <tbody className="divide-y divide-gray-100">
                                ...
                                {batches.map((batch) => (
                                    <tr key={batch.id} className="hover:bg-muted transition-colors group">
                                        ...
                                        <td className="px-6 py-4">
                                            <span className="font-mono font-bold text-foreground">-- %ile</span>
                                        </td>
