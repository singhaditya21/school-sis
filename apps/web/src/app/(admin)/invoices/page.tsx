...
const STATUS_STYLES: Record<string, string> = {
    ...
    PENDING: 'bg-muted text-foreground dark:bg-slate-800 dark:text-slate-200',
    OVERDUE: 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300',
    CANCELLED: 'bg-muted text-muted-foreground dark:bg-slate-800 dark:text-muted-foreground',
