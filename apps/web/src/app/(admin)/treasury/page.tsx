import { getTreasurySummaryAction } from '@/lib/actions/treasury';
        ...
        <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-8 min-h-screen">
            ...
            <Card className="border border-gray-200 shadow-sm bg-white overflow-hidden mt-8">
                <CardHeader className="bg-gray-50/50 border-b border-gray-100 px-6 py-5 flex flex-row items-center justify-between">
                    ...
                    <Badge variant="destructive" className="bg-red-100 text-red-700 border-0">4 Alerts</Badge>
                </CardHeader>
                        ...
                        <table className="w-full text-sm text-left">
                            ...
                            <tbody className="divide-y divide-gray-100">
                                <tr className="hover:bg-gray-50 transition-colors">
                                    <td className="px-6 py-4 font-mono font-bold text-gray-500 text-xs">txn_74h284jf</td>
                                    <td className="px-6 py-4 font-semibold">Stripe (USD)</td>
                                    <td className="px-6 py-4 font-mono">$4,200.00</td>
                                    <td className="px-6 py-4"><Badge variant="outline" className="text-orange-600 bg-orange-50 border-orange-200">Chargeback Initiated</Badge></td>
                                    <td className="px-6 py-4 text-right"><Button variant="ghost" size="sm" className="text-blue-600">Challenge</Button></td>
                                </tr>
                                <tr className="hover:bg-gray-50 transition-colors">
                                    <td className="px-6 py-4 font-mono font-bold text-gray-500 text-xs">txn_p398d2jk</td>
                                    <td className="px-6 py-4 font-semibold">Razorpay (INR)</td>
                                    <td className="px-6 py-4 font-mono">₹1,45,000.00</td>
                                    <td className="px-6 py-4"><Badge variant="outline" className="text-red-600 bg-red-50 border-red-200">Failed: Network Err</Badge></td>
                                    <td className="px-6 py-4 text-right"><Button variant="ghost" size="sm" className="text-blue-600">Sync Log</Button></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
